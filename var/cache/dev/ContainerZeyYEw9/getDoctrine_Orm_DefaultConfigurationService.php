...
$b = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'/config/mapping/orm') => 'App\\DDD\\Domain\\Entity'));
$b->setGlobalBasename('mapping');

$a->addDriver($b, 'App\\DDD\\Domain\\Entity');

$instance->setEntityNamespaces(array('DDD\\Domain\\Model\\Entity' => 'App\\DDD\\Domain\\Entity'));
...
$instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, array(
    'App\\DDD\\Infrastructure\\User\\Repository\\UserCommandRepository' => array('privates', 'App\\DDD\\Infrastructure\\User\\Repository\\UserCommandRepository', 'getUserCommandRepositoryService.php', true),
    'App\\DDD\\Infrastructure\\User\\Repository\\UserQueryRepository' => array('privates', 'App\\DDD\\Infrastructure\\User\\Repository\\UserQueryRepository', 'getUserQueryRepositoryService.php', true),
))));
