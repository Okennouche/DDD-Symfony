...
// Returns the private 'App\DDD\Infrastructure\User\Repository\UserQueryRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/DDD/Domain/Repository/User/Interfaces/UserQueryRepositoryInterface.php';
include_once $this->targetDirs[3].'/src/DDD/Infrastructure/User/Repository/UserQueryRepository.php';

return $this->privates['App\DDD\Infrastructure\User\Repository\UserQueryRepository'] = new \App\DDD\Infrastructure\User\Repository\UserQueryRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
